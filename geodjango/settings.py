...
DATABASES = {
    'default': {
        ...
        'NAME': '/home/adli/geodjango/geodjango.db',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = '/home/adli/geodjango/media/'
...
STATIC_ROOT = '/home/adli/geodjango/static/'
...
SECRET_KEY = 'kp#-#x^iy%hz@idctp2_=7454+)_)b8hj3e)nxzotiwzhj4#-6'
